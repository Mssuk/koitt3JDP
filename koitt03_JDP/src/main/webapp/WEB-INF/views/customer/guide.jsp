	...
	<div id="container">
		...
		<div id="outbox">		
			...
			<div id="contents">
				...
				<h3 class="dvd-head">이용약관</h3>
				<div class="">

					<div class="provision">
						<h4 id="privacy-num-1">제1조 (목적)</h4>
						...
						<h4 id="privacy-num-1">제 2조 (정의)</h4>

						<ol>
							<li>"서비스"란 ㈜쟈뎅이 재화·용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화·용역을 거래할 수 있도록 설정한 가상의 영업장 또는 회사가 운영하는 웹사이트를 말하며, 통합된 하나의 회원 계정(ID 및 비밀번호)을 이용하여 서비스를 제공받을 수 있는 아래의 사이트를 의미합니다. 아울러 사이트를 운영하는 사업자의 의미로도 사용합니다.
								<ul>
									<li>(주)쟈뎅: www.jardin.co.kr</li>
									<li>쇼핑몰: www.jardinshop.co.kr</li>
								</ul>
							</li>
						...
						<h4 id="privacy-num-1">제 3조 (약관의 명시와 개정)</h4>
						...
						<ol>
							...
							<li>"(주)쟈뎅"이 약관을 개정할 경우에는 그 개정약관은 그 적용일자 이후에 체결되는 계약에만 적용되고 그 이전에 이미 체결된 계약에 대해서는 개정전의 약관조항이 그대로 적용됩니다. 다만 이미 계약을 체결한 이용자가 개정약관 조항의 적용을 받기를 원하는 뜻을 상기 제3항에 의한 개정약관의 공지기간내에 "(주)쟈뎅"에 송신하여 "(주)쟈뎅"의 동의를 받은 경우에는 개정약관 조항이 적용됩니다.</li>
							<li>이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 정부가 제정한 전자거래소비자보호지침 및 관계법령 또는 상관례에 따릅니다.</li>
						</ol>

						<h4 id="privacy-num-1">제 4조 (서비스의 제공 및 변경)</h4>
						<p>"(주)쟈뎅"은 다음과 같은 업무를 수행합니다.</p>

						<ol>
							<li>재화 또는 용역에 대한 정보 제공 및 구매계약의 체결</li>
							<li>구매계약이 체결된 재화 또는 용역의 배송</li>
							<li>기타 "(주)쟈뎅"이 정하는 업무</li>
						</ol>

						<h4 id="privacy-num-1">제 5조 (서비스의 중단)</h4>
						...
						<h4 id="privacy-num-1">제 6조 (회원가입)</h4>

						<ol>
							<li>이용자는 "(주)쟈뎅"이 정한 가입 양식에 따라 회원정보를 기입한 후 이 약관에 동의한다는 의사표시를 함으로서 회원가입을 신청합니다.</li>
							<li>"(주)쟈뎅"은 제 1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각호에 해당하지 않는 한 회원으로 등록합니다.
								<ol>
									<li>가입신청자가 이 약관 제7조제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 다만 제7조제3항에 의한 회원자격상실후 3년이 경과한 자로서 "(주)쟈뎅"의 회원재가입 승낙을 얻은 경우에는 예외로 한다.</li>
									<li>등록내용에 허위, 기재누락, 오기가 있는 경우</li>
									<li>기타 회원으로 등록하는 것이 "(주)쟈뎅"의 기술상 현저히 지장이 있다고 판단되는 경우</li>
								</ol>
							</li>
						</ol>

						<h4 id="privacy-num-1">제 7조 (회원탈퇴 및 자격상실등)</h4>

						<ol>
							<li>회원은 "(주)쟈뎅"에 언제든지 탈퇴를 요청할 수 있으며, "(주)쟈뎅"은 즉시 회원탈퇴를 처리합니다.</li>
							<li>회원이 다음 각 호의 사유에 해당하는 경우, "(주)쟈뎅"은 회원자격을 제한 및 정지시킬 수 있습니다.
								<ol>
									<li>가입 신청시에 허위 내용을 등록한 경우</li>
									<li>"(주)쟈뎅"을 이용하여 구입한 재화·용역 등의 대금, 기타 "(주)쟈뎅" 이용에 관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우</li>
									<li>타인의 "(주)쟈뎅" 이용을 방해하거나 그 정보를 도용하는 등 전자거래질서를 위협하는 경우</li>
									<li>"(주)쟈뎅"을 이용하여 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우</li>
								</ol>
							</li>
						</ol>

						<h4 id="privacy-num-1">제 8조 (회원에 대한 통지)</h4>
						...
						<h4 id="privacy-num-1">제 9조 (회원에 대한 특전)</h4>

						<ol>
							<li>"(주)쟈뎅"에 회원으로 가입한 자는 상품 구입 금액의 3%를 포인트로 적립받을 수 있으며, 적립한 포인트는 구매 시 현금처럼 사용할 수 있습니다. (단, 일부 상품 제외)</li>
						...
						<h4 id="privacy-num-1">제 10조 (구매신청)</h4>
						<p>"(주)쟈뎅" 이용자는 온라인 상에서 이하의 방법에 의하여 구매를 신청합니다.</p>

						<ol>
							<li>재화(상품) 또는 용역의 선택</li>
							<li>회원가입</li>
							<li>배송정보 입력</li>
							<li>결제방식의 선택</li>
							<li>성명, 주소, 전화번호 입력</li>
							<li>이 약관에 동의한다는 의사표시 (예, 마우스 클릭)</li>
						</ol>

						<h4 id="privacy-num-1">제 11조 (계약의 성립)</h4>
						<ol>
							<li>"(주)쟈뎅"은 제13조와 같은 구매신청에 대하여 다음 각 호에 해당하지 않는 한 승낙합니다.
								<ol>
									<li>신청 내용에 허위, 기재누락, 오기가 있는 경우</li>
									<li>미성년자가 담배, 주류 등 청소년보호법에서 금지하는 재화 및 용역을 구매하는 경우</li>
									<li>기타 구매신청에 승낙하는 것이 "(주)쟈뎅"의 기술상 현저히 지장이 있다고 판단하는 경우</li>
								</ol>
							</li>
						...
						<h4 id="privacy-num-1">제 12조 (지급방법)</h4>
						<p>"(주)쟈뎅"에서 구매한 재화 또는 용역에 대한 대금지급은 구매한 재화 또는 용역을 수령시에 직접 지급합니다.(후불제)</p>		
						
						<h4 id="privacy-num-1">제 13조 (수신확인통지·구매신청 변경 및 취소)</h4>
						<ol>
						...
						<h4 id="privacy-num-1">제 14조 (배송)</h4>
						...
						<h4 id="privacy-num-1">제 15조 (환급, 반품 및 교환)</h4>
						<ol>
							...
							<li>다음 각 호의 경우에는 "(주)쟈뎅"은 배송된 재화일지라도 재화를 반품 받은 다음 영업일 이내에 이용자의 요구에 따라 즉시 환급, 반품 및 교환 조치를 합니다. 다만 그 요구 기한은 배송된 날로부터 20일 이내로 합니다.
								<ol>
									<li>배송된 재화가 주문내용과 상이하거나 "(주)쟈뎅"이 제공한 정보와 상이할 경우</li>
						...
						<h4 id="privacy-num-1">제 16조 (개인 정보 보호)</h4>
						<ol>
							<li>"(주)쟈뎅"은 회원의 정보수집시 구매계약 및 기타 서비스의 제공에 필요한 최소한의 정보를 수집합니다. 다음 사항을 필수사항으로하며 그 외 사항은 선택사항으로 합니다.
								<ol>
									<li>개인식별 목적 :성명, 주민등록번호, 생년월일</li>
									<li>개인정보 보호 목적 : 희망ID ,비밀번호</li>
									<li>통지 및 배송 목적 : 주소, 이메일 주소, 전화번호, 이동통신 전화번호, 회사명, 대표자명, 업태, 업종, 사업자등록번호, 메일수신여부</li>
								</ol>
							</li>
							<li>"(주)쟈뎅"은 회원의 개인식별이 가능한 개인정보를 수집하는 때에는 반드시 당해 회원의 동의를 받습니다.</li>
							<li>제공된 개인정보는 당해 이용자의 동의 없이 목적외의 이용이나 제3자에게 제공할 수 없으며, 이에 대한 모든 책임은 "(주)쟈뎅"이 부담합니다. 다만, 다음의 경우에는 예외로 합니다.
								<ol>
									...
									<li>㈜쟈뎅의 각종 이벤트 행사시, 행사에 참여한 회원의 개인정보를 필요시에 해당 이벤트의 주최자에게 제공하는 경우</li>
						...
						<h4 id="privacy-num-1">제 17조 (㈜쟈뎅의 의무)</h4>
						<ol>
						...
						<h4 id="privacy-num-1">제 18조 (회원의 ID 및 비밀번호에 대한 의무)</h4>
						<ol>
						...
						<h4 id="privacy-num-1">제 19조 (이용자의 의무)</h4>
						<p>이용자는 다음 행위를 하여서는 안됩니다.</p>
						<ol>
							<li>신청 또는 변경시 허위내용의 등록</li>
							<li>"(주)쟈뎅"에 게시된 정보의 변경</li>
							<li>"(주)쟈뎅"이 정한 정보 이외의 정보(컴퓨터 프로그램 등)의 송신 또는 게시</li>
							<li>"(주)쟈뎅" 기타 제3자의 저작권 등 지적재산권에 대한 침해</li>
							<li>"(주)쟈뎅" 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위</li>
							<li>외설 또는 폭력적인 메시지·화상·음성 기타 공서양속에 반하는 정보를 "(주)쟈뎅"에 공개 또는 게시하는 행위</li>
						</ol>

						<h4 id="privacy-num-1">제 20 조 (게시물 관리)</h4>
						...
						<ol>
							...
							<li>"(주)쟈뎅"의 저작권, 제 3 자의 저작권 등 기타 권리를 침해하는 내용인 경우</li>
							<li>"(주)쟈뎅"에서 규정한 게시기간이나 용량을 초과한 경우</li>
							<li>기타 관계법령에 위반된다고 판단되는 경우</li>
						</ol>

						<h4 id="privacy-num-1">제 21 조 (저작권의 귀속 및 이용제한)</h4>
						<ol>
						...
						<h4 id="privacy-num-1">제 22조 (사이트의 연결)</h4>
						<ol>
						...
						<h4 id="privacy-num-1">제 23조 (광고게재 등)</h4>
						<ol>
						...
						<h4 id="privacy-num-1">제 24조 (면책)</h4>
						<ol>
						...
						<h4 id="privacy-num-1">제 25조 (분쟁해결)</h4>
						<ol>
