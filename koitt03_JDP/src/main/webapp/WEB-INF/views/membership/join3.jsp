                    ...
                    <div class="memberbd">
                        <table
                            ...
                            <tr>
                                ...
                                <td class="r10"><input type="text" class="w134" name="name"/>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <ul class="pta">
                                        ...
                                        <li>
                                            <button type="button" class="nbtnMini" onclick="id_ch()">중복 확인</button>
                                        </li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="pta">
                                        ...
                                        <li><span class="mvalign">※ 영문 / 숫자 / 특수문자 혼용으로 8~20자 까지 가능.</span></li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <ul class="question">
                                        <li><input type="radio" name="receive" id="receive_yes"
                                                   class="radio_t" checked="checked"/><label for="receive_yes">예</label>
                                        </li>
