...
<%-- 										<c:out value="${fn:substring(name, 0, 1) }*${fn:substring(name, 2, totalLength) }"/>  --%>
										<span>[<fmt:formatDate value="${re_dtos.event_re_modify }" pattern="yyyy-MM-dd  HH:mm:ss"/>]</span></li>
									    <c:choose>
