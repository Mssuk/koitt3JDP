...
<div id="ieUser" style="display:none">
    <div class="iewrap">
        ...
        <ul>
            <li><a href="http://windows.microsoft.com/ko-kr/internet-explorer/download-ie" target="_blank"><img
                    src="${pageContext.request.contextPath}/images/ico/ico_ie.gif" alt="IE 최신브라우저 다운"></a></li>
            <li><a href="https://www.google.com/intl/ko/chrome/browser" target="_blank"><img
                    src="${pageContext.request.contextPath}/images/ico/ico_chrome.gif" alt="IE 최신브라우저 다운"></a></li>
            <li><a href="http://www.mozilla.org/ko/firefox/new" target="_blank"><img
                    src="${pageContext.request.contextPath}/images/ico/ico_mozila.gif" alt="MOZILA 최신브라우저 다운"></a></li>
            <li><a href="http://www.apple.com/safari" target="_blank"><img
                    src="${pageContext.request.contextPath}/images/ico/ico_safari.gif" alt="SAFARI 최신브라우저 다운"></a></li>
            <li><a href="http://www.opera.com/ko/o/ie-simple" target="_blank"><img
                    src="${pageContext.request.contextPath}/images/ico/ico_opera.gif" alt="OPERA 최신브라우저 다운"></a></li>
        </ul>
        <p class="btn" onclick="msiehide();"><img src="${pageContext.request.contextPath}/images/ico/ico_close.gif"
                                                  alt="닫기"/></p>
    </div>
</div>
<!--//익스레이어팝업-->
            ...
            <div id="snbBox">
                ...
                <div id="quickmenu">
                    <div id="mnaviOpen"><img
                            ...
                            width="33" height="31" alt="메뉴열기"/></div>
                    <div id="mnaviClose"><img
                ...
                <div id="snb">
                    ...
                    <div id="search">
                        ...
                        <input type="image"
                               src="${pageContext.request.contextPath}${pageContext.request.contextPath}/images/btn/btn_main_search.gif"
