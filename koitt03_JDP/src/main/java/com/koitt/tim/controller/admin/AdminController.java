...
public class AdminController {
	...
	// orderStatus 변경하기
	@PatchMapping("olist/{code}/{value}")
	public void oList(@PathVariable("code") String o_num, @PathVariable("value") String o_status) {
		logger.info("{}", o_num);
		logger.info("{}", o_status);
		adminService.updateOrderStatus(o_num, o_status);
	}

	// order에 대한 payment 가져오기
	...
	public void cList(@PathVariable("code") String key, @PathVariable("val1") String c_type,
			@PathVariable("val2") String c_state) {
